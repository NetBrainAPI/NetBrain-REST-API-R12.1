...
|option.rawData|bool|True - indicates that there is always raw data <br />False - indicates that it is not mandatory to save raw data. Whether to save raw data depends on the definition of NI <br /><br />Default: False <br /><br />e.g. if status code is defined, there must be raw data |
