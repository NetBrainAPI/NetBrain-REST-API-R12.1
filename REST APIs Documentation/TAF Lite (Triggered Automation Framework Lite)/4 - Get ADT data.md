...
|columns^|array|Column display name list, used to define the returned columns. </br>If the value of this parameter is empty, all columns will be returned. |
|option^|object|Advanced setting|
|option.rowFilter	|object|JSON object <br /><br />ColumnDisplayName: value <br /><br />AND logic is used to combine multiple values. |
